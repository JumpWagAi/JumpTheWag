    ...
    <div className="min-h-screen bg-void text-white px-6 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-neutral-light/80 leading-relaxed text-sm sm:text-base">
          <h2 className="text-2xl font-bold text-white pt-4">Agreement to Our Legal Terms</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">1. Our Services</h2>
          ...
          <h3 className="text-lg font-semibold text-white">Your use of our Services</h3>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">3. User Representations</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">4. Prohibited Activities</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">5. User Generated Contributions</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">6. Contribution License</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">7. Services Management</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">8. Term and Termination</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">9. Modifications and Interruptions</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">10. Governing Law</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">11. Dispute Resolution</h2>

          <h3 className="text-lg font-semibold text-white">Informal Negotiations</h3>
          <p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a "Dispute" and collectively, the "Disputes") brought by either you or us (individually, a "Party" and collectively, the "Parties"), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least 30 days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.</p>

          <h3 className="text-lg font-semibold text-white">Binding Arbitration</h3>
          ...
          <h3 className="text-lg font-semibold text-white">Exceptions to Informal Negotiations and Arbitration</h3>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">12. Corrections</h2>
          <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>

          <h2 className="text-2xl font-bold text-white pt-4">13. Disclaimer</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">14. Limitations of Liability</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">15. Indemnification</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">16. User Data</h2>
          <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

          <h2 className="text-2xl font-bold text-white pt-4">17. Electronic Communications, Transactions, and Signatures</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">18. Miscellaneous</h2>
          ...
          <h2 className="text-2xl font-bold text-white pt-4">19. Contact Us</h2>
