    ...
    <div className="min-h-screen bg-void text-text-default px-6 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-neutral-light/80 leading-relaxed text-sm sm:text-base">
          <h2 className="text-2xl font-bold text-text-default pt-4">Agreement to Our Legal Terms</h2>
          <p>We are Jumpwag (<strong>"Company," "we," "us," "our"</strong>).</p>
          ...
          <p>You can contact us by email at <a href="mailto:jumpwagai@gmail.com" className="text-accent hover:underline">jumpwagai@gmail.com</a>.</p>
          <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Jumpwag, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">1. Our Services</h2>
          <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>

          <h2 className="text-2xl font-bold text-text-default pt-4">2. Intellectual Property Rights</h2>

          <h3 className="text-lg font-semibold text-text-default">Our intellectual property</h3>
          ...
          <h3 className="text-lg font-semibold text-text-default">Your use of our Services</h3>
          ...
          <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to <a href="mailto:jumpwagai@gmail.com" className="text-accent hover:underline">jumpwagai@gmail.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
          <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
          <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>

          <h3 className="text-lg font-semibold text-text-default">Your submissions</h3>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">3. User Representations</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">4. Prohibited Activities</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">5. User Generated Contributions</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">6. Contribution License</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">7. Services Management</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">8. Term and Termination</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">9. Modifications and Interruptions</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">10. Governing Law</h2>
          <p>These Legal Terms shall be governed by and defined following the laws of Nigeria. Jumpwag and yourself irrevocably consent that the courts of Nigeria shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>

          <h2 className="text-2xl font-bold text-text-default pt-4">11. Dispute Resolution</h2>

          <h3 className="text-lg font-semibold text-text-default">Informal Negotiations</h3>
          <p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a "Dispute" and collectively, the "Disputes") brought by either you or us (individually, a "Party" and collectively, the "Parties"), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least 30 days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.</p>

          <h3 className="text-lg font-semibold text-text-default">Binding Arbitration</h3>
          <p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be 3. The seat, or legal place, or arbitration shall be Nigeria. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of Nigeria.</p>

          <h3 className="text-lg font-semibold text-text-default">Restrictions</h3>
          <p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.</p>

          <h3 className="text-lg font-semibold text-text-default">Exceptions to Informal Negotiations and Arbitration</h3>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">12. Corrections</h2>
          <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>

          <h2 className="text-2xl font-bold text-text-default pt-4">13. Disclaimer</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">14. Limitations of Liability</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">15. Indemnification</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">16. User Data</h2>
          <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

          <h2 className="text-2xl font-bold text-text-default pt-4">17. Electronic Communications, Transactions, and Signatures</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">18. Miscellaneous</h2>
          ...
          <h2 className="text-2xl font-bold text-text-default pt-4">19. Contact Us</h2>
          <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at <a href="mailto:jumpwagai@gmail.com" className="text-accent hover:underline">jumpwagai@gmail.com</a>.</p>
        </div>
      </div>
    </div>
  )
